...
//apliquem social laws no es pot moure si hi ha cotxe a on es vol moure i preferència a les caselles centrals
...
{				
        ...
        for(i=8;i<12;i++)
	{
		...
		{
			branch[i]=1;
			if(v[nextp[i][0]]==0)		//es pot moure a la casella central
                	        branch[i]+=1;
